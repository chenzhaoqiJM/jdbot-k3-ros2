...
// The ROS Humble binary package installs libcartographer but omits internal
// headers. Keeping this exact-version declaration allows this front-end-only
// node to instantiate LocalTrajectoryBuilder2D without copying its algorithms.
