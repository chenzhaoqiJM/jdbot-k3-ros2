...
def generate_launch_description():
    ...
    arguments = [
        ...
        DeclareLaunchArgument('resize_for_orb', default_value='false'),
        DeclareLaunchArgument('tracking_width', default_value='640'),
        DeclareLaunchArgument('tracking_height', default_value='360'),
