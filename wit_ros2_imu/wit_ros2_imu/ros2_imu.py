...
class IMUDriverNode(Node):
    ...
    def publish_imu(self):
        ...
        # 协方差
        self.imu_msg.orientation_covariance = [0.0001, 0., 0.,  0., 0.0001, 0.,  0., 0., 0.0001]
        self.imu_msg.angular_velocity_covariance = [0.0001, 0., 0., 0., 0.0001, 0., 0., 0., 0.0001]
        self.imu_msg.linear_acceleration_covariance = [0.001, 0., 0., 0., 0.001, 0., 0., 0., 0.001]
